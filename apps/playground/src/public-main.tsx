...
if (path.startsWith("/playground")) {
  ...
  function Home() {
    ...
    </main><footer className="public-footer"><span>Aeliqo 0.2.0</span><span>React-first · Application-owned data · Agent optional</span></footer></div>;
  }
  ...
  function Changelog() { return <div className="public-site aeliqo-theme" data-aeliqo-theme="light"><PublicNav /><main className="public-main changelog"><p className="eyebrow">CHANGELOG</p><h1>Release history</h1><article><header><strong>0.2.0</strong><span>7 September 2026 · public release</span></header><p>Five installable packages, twenty direct component entry points, smart investigation components, typed range and group selection, deterministic explainable adaptation, explicit MCP pairing, local BYOK integration, and experimental WebMCP support.</p><ul><li>Install from npm with React 18.3 or 19 and the tested Next.js App Router pairs.</li><li>Use MetricBreakdown, EventTimeline, TimeInvestigation, and QualityPanel with application-owned data.</li><li>Compose the same renderers manually, semantically, or through validated workspace operations.</li></ul></article><p>Historical proof milestones remain in the engineering documentation and are not presented as separate registry releases.</p></main></div>; }

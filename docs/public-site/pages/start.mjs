...
export const startPages = [
  definePage('home', {
    ...
    body: `
<section class="docs-landing-hero"><div><p class="lead">Aeliqo is an application-controlled UI framework. Your application registers meaning, data, authority, actions, and views. Application code—or an optional agent—sends a typed intent through the same validated runtime.</p><div class="docs-landing-actions"><a class="primary" href="/start/">Start the 10-minute quickstart <span aria-hidden="true">→</span></a><a href="/playground/">Open the playground</a></div></div><dl class="docs-facts"><div><dt>01</dt><dd>Define a resource</dd></div><div><dt>02</dt><dd>Mount a Region</dd></div><div><dt>03</dt><dd>Render an intent</dd></div></dl></section>
...
${cards([
  {
    ...
    body: 'Build one complete resource-to-Region path with all required files and no hidden helpers.',
    href: '/start/',
    label: 'Follow the quickstart',
  },
  {
    title: 'Add it to an existing app',
    body: 'Adopt one surface while keeping your backend, router, state, and design system.',
    href: '/start/existing-app/',
    label: 'See the integration path',
  },
  {
    title: 'Connect an agent',
    body: 'Expose three bounded tools through MCP, WebMCP, or a provider-agnostic BYOK host.',
    href: '/agents/quickstart/',
    label: 'Connect safely',
  },
  {
    title: 'Explore working scenarios',
    body: 'Inspect People, Products, Support, and Knowledge through the real public runtime.',
    href: '/playground/',

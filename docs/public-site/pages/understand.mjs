...
${next([{href: '/concepts/intent/', title: 'Intent contract', description: 'See the six standard intents and extension path.'}, {href: '/concepts/safety/', title: 'Safety model', description: 'Understand the non-bypassable validation gates.'}])}`,
  }),
...
${next([{href: '/reference/intent-schema/', title: 'Intent schema', description: 'Inspect fields and validation behavior.'}, {href: '/guides/custom-views/', title: 'Extensions', description: 'Add custom behavior without enlarging core.'}])}`,
  }),
...
${next([{href: '/guides/resources/', title: 'Resource metadata', description: 'Declare field roles and connect an existing Catalog.'}, {href: '/concepts/safety/', title: 'Semantic validation', description: 'See how invalid operations are rejected.'}])}`,
  }),
...
${next([{href: '/guides/responsive-behavior/', title: 'Responsive policy', description: 'See view choices by task and container.'}, {href: '/guides/forms/', title: 'Form UX', description: 'Keep draft and validation ownership explicit.'}])}`,
  }),
...
${next([{href: '/agents/recovery/', title: 'Agent recovery', description: 'Turn failures and ambiguity into understandable user choices.'}, {href: '/reference/diagnostics/', title: 'Diagnostics', description: 'Map stable codes to recovery.'}])}`,
  }),
];

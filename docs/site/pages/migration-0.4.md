...
description: 'Move from the live Aeliqo 0.4.2 compatibility surface to the unreleased, breaking vNext candidate.'
---

## Release line and compatibility

Aeliqo `0.4.2` remains the live, stable release. The vNext work is prepared as
the unreleased `0.5.0` line because it adds breaking public surface and scoped
runtime contracts. Nothing on this page changes the published `0.4.2` packages;
use the candidate only after its own release gates and publication are approved.

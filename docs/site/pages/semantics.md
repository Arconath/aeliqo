...
<h2>Example: a registered meaning</h2><p>This is the month-end headcount meaning from the maintained quickstart fixture. It is a reviewable contract, not a SQL fragment: it fixes the output kind and grain, the aggregation rule, and the missing-value policy.</p>

...
<h2>One request, end to end</h2><p>Given a registered <code>people</code> resource, this input travels through every stage above and returns a typed receipt:</p>
...
<p>A button, route, test, or agent sends the same shape; each stage can narrow it or stop it, but none can widen it into unregistered behavior.</p>

...
<p class="lead">Products proves that Aeliqo can select grid, list, comparison, detail, and form recipes from one resource—without generated HTML.</p>
<h2>Journeys</h2><div class="doc-checklist"><ul><li>Browse products as grid on wide containers and an equivalent list or cards on narrow containers.</li><li>Open detail using stable product identity.</li><li>Compare selected products without collapsing essential attributes.</li><li>Open a registered create/edit form without executing a write.</li><li>Preserve filters and comparison selection across valid adaptation.</li></ul></div>

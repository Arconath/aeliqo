...
| ---- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| T00  | in-progress                      | Remote, policy, toolchain, catalog, package/export and workflow baseline recorded; harness and focused checks pass. The first full check reached 39/83 before the unchanged-source guard observed concurrent task writes; rerun from the next stable commit. |
...
| T02  | implemented-and-focused-verified | Immutable data/non-data definitions, compatibility lowering, package export/docs and clean tarball consumer pass; collision and nested-mutation regressions added after independent review. Full matrix remains pending.                                     |

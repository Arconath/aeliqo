...
Each request evaluates one registered query. The integrating application owns
result composition, UI presentation, authentication, and authorization policy.

...
const port = await testPort("AELIQO_NAVIGATION_FEEDBACK_SEMANTIC_PORT");
...
export default defineConfig({
  ...
  timeout: 30_000,
  outputDir: resolve(repositoryRoot, "artifacts/navigation-feedback-semantic-browser"),
  ...
  webServer: {
    ...
    cwd: repositoryRoot,
    url: `${origin}/tests/navigation-feedback-semantic/index.html`,

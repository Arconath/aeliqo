...
const port = await testPort("AELIQO_NAVIGATION_TEST_PORT");
...
export default defineConfig({
  ...
  timeout: 30_000,
  outputDir: resolve(repositoryRoot, "artifacts/navigation-browser"),
  ...
  webServer: {
    ...
    cwd: repositoryRoot,
    url: `${origin}/tests/navigation/index.html`,

...
const port = await testPort("AELIQO_DATA_SEMANTIC_PORT");
...
export default defineConfig({
  ...
  timeout: 30_000,
  outputDir: resolve(repositoryRoot, "artifacts/data-semantic-browser"),
  ...
  webServer: {
    ...
    cwd: repositoryRoot,
    url: `${origin}/tests/data-semantic/index.html`,

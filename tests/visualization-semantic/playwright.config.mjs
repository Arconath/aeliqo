...
const port = await testPort("AELIQO_VISUALIZATION_SEMANTIC_PORT");
...
export default defineConfig({
  ...
  timeout: 30_000,
  outputDir: resolve(repositoryRoot, "artifacts/visualization-semantic-browser"),
  ...
  webServer: {
    ...
    cwd: repositoryRoot,
    url: `${origin}/tests/visualization-semantic/index.html`,

...
`);
 ...
 await writeFile(join(consumer,'browser.js'),`import {AeliqoButtonElement} from '@aeliqo/web/button';customElements.define('aeliqo-button',AeliqoButtonElement);const button=document.createElement('aeliqo-button');button.label='Direct installed';document.body.append(button);`);
 run([join(consumer,'node_modules/.bin/vite'),'build'],consumer);

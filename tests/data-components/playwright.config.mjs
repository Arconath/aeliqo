...
export default defineConfig({outputDir:"../../artifacts/data-components-browser",
  ...
  webServer: {command: `./node_modules/.bin/vite --host 127.0.0.1 --port ${port} --strictPort`, cwd: repositoryRoot, url: `${origin}/tests/data-components/index.html`, reuseExistingServer: false, timeout: 120_000},
});

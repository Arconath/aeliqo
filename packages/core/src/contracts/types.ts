...
export type Contract<K extends ContractKind> = K extends 'plot-spec' ? PlotSpec : K extends 'visualization-spec' ? VisualizationSpec : Wire<z.infer<(typeof contractSchemas)[K]>>;

...
export const contractSchemas: Readonly<{
  ...
  'result-event': resultEventSchema,
  environment: environmentSchema,
  'presentation-plan': presentationPlanSchema,
  'task-proposal': taskProposalSchema,
  'meaning-draft': meaningDraftSchema,
  'binding-outcome': bindingOutcomeSchema,
  'operation-grant': operationGrantSchema,
  'agent-loop-budget': agentLoopBudgetSchema,
  'agent-stop-reason': agentStopReasonSchema,
  'narrative-claim': narrativeClaimSchema,

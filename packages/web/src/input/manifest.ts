...
export const AELIQO_INPUT_MANIFESTS: readonly AeliqoInputManifest[] = [
  ...
  manifest(AELIQO_INPUT_REFS.form, "aeliqo-form", "structure", ["form", "error-summary", "submit"], ["aeliqo-form-submit", "aeliqo-form-reset"], ["label", "noValidate", "submitLabel"], (input) => validate(AELIQO_INPUT_REFS.form, ["label", "noValidate", "submitLabel"], input, {label: (value) => stringField(value, 512), noValidate: booleanField, submitLabel: (value) => stringField(value, 256)})),
];

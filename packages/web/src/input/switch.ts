  ...
  static readonly styles = [
    ...
    css`
      ...
      .switch-track {
        ...
        inline-size: 2.75rem;
        padding: 0.125rem;
        transition: background-color var(--aeliqo-motion-duration-fast, 120ms) ease;
      }
      .switch-thumb {
        ...
        transition: transform var(--aeliqo-motion-duration-fast, 120ms) ease;
      }
      input {
        block-size: 1px;
        inline-size: 1px;

...
export function renderInputNode(node: Node, child: (id: string) => unknown, emit: AeliqoInputEmit): TemplateResult | typeof nothing | undefined {
  const v = common(node);

...
import {activeElement, focusFirst, focusLast, interactiveSelector, listenOutside, nextFrame, restoreFocus, emitAction, safeElementId} from "../navigation/shared.js";
...
export class AeliqoPopoverElement extends AeliqoFoundationElement {
  ...
  private keydown(event: KeyboardEvent): void {
    ...
    const firstFocusable = first.querySelector<HTMLElement>(interactiveSelector);
    const lastFocusable = [...first.querySelectorAll<HTMLElement>(interactiveSelector)].at(-1);

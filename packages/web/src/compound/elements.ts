...
export class AeliqoInvestigationElement extends AeliqoCompoundElement {
  ...
  static readonly styles = [...aeliqoCompoundThemeStyles, css`[part="caution"] { border-inline-start: .25rem solid var(--aeliqo-color-warning, #b54708); overflow-wrap: anywhere; padding-inline-start: var(--aeliqo-space-12, .75rem); unicode-bidi: plaintext; }`];
